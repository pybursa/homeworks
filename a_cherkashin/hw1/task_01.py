...
print "Solution 1: " + user_input[::-1]
print "Solution 2: " + ''.join(reversed(user_input))
print "Solution 3: " + reverse_recursive(user_input)
print "Solution 4: " + reverse_by_loop(user_input)
